          ...
          <div className={"z-20 container mx-auto flex flex-col gap-6 mb-6"}>
            <Card className={'pb-0'}>
              ...
              <div className={'flex justify-center overflow-hidden relative h-20'}>
                <h2 className={'bg-gradient-to-b from-brand to-brand/0 text-transparent text-[128px] font-medium tracking-widest z-30 bg-clip-text absolute -top-9'}>Bas Mensinga</h2>
              </div>
            </Card>
          </div>
